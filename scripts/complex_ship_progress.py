...
p=scene.fal_h3_live;p.grid_guidance='PER_STYLE_TEXT';p.grid_seed=112358;p.style_manifest='' ;p.preview_mode='REFERENCE';p.source_format='JPEG';p.resolution='768P';p.max_requests=32;p.settle_seconds=.8
