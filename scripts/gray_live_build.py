...
base_prompt='Object category: a small steel coastal workboat. Image 1 is its coarse design proxy. Preserve its current component layout and degree of assembly while interpreting the existing parts as real manufactured boat construction. Smooth away tessellation artifacts and coarse faceting; preserve the overall design envelope rather than individual mesh edges. The gray floor becomes water. CURRENT ASSEMBLY: '
